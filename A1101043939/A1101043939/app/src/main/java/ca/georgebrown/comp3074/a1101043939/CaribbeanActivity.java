...
public class CaribbeanActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItems = getResources().getStringArray(R.array.caribbeanMenuList);
        ...
        popMenuBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CaribbeanActivity.this);
