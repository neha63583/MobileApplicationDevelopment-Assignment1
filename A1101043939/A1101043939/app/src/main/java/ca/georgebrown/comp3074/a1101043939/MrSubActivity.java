...
public class MrSubActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mr_sub);


        selectedItemsTextView= (TextView) findViewById(R.id.selectedItemsTextView);
        listItems = getResources().getStringArray(R.array.subMenuList);
        ...
        popMenuBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(MrSubActivity.this);
