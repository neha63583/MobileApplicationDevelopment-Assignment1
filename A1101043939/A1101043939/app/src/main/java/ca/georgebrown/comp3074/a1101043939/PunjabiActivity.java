...
public class PunjabiActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItems = getResources().getStringArray(R.array.punjabiMenuList);
        ...
        popMenuBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PunjabiActivity.this);
