...
public class PopeyesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItems = getResources().getStringArray(R.array.popMenuList);
        ...
        addToCartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PopeyesActivity.this);
