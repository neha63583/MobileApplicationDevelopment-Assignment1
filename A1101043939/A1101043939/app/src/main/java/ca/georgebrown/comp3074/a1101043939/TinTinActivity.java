...
public class TinTinActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItems = getResources().getStringArray(R.array.tinMenuList);
        ...
        popMenuBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TinTinActivity.this);
